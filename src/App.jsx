...
function App() {
  ...
  return (
    <div className="w-[100vw] h-[100vh] flex justify-center items-center bg-[#344151] flex-col gap-10">
      ...
      <div className="text-[white] font-medium">Increment & Decrement</div>
      ...
      <button onClick={resetHandler} className="bg-white text-black px-5 py-2 rounded-sm text-lg">Reset</button>
